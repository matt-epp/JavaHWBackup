...
public class E209Map {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <dataList.size() ; i++) {
            Set<Map.Entry<String,Object>> entrySet=appleMap.entrySet();
            var values =entrySet.forEach(x-> x.getValue());
            var keys= appleMap.keySet();
            var values=appleMap.values();
            int subtotal=keys*values;
